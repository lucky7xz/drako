...
A spec listing more than 9 profiles asks for confirmation before applying: the
profiles past the ninth still work and are reachable by cycling with `o`/`p`,
they just don't get a `1-9` chord of their own.
